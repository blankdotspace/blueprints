...
import { UserTier, SecurityLevel, isModelCompatible } from '@eliza-manager/shared'; // Removed resolveSecurityLevel
...
export default function OpenClawWizard({ agent, onSave, onClose }: OpenClawWizardProps) {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const message = err instanceof Error ? err.message : 'Neural uplink corrupted';
